<?php
  ...
  if($id==null||$time==null||$work==null||$location==null){
	print "<script language=javascript> alert('빈칸이있습니다'); location.replace('User.php'); </script>";
}

	$connect = mysqli_connect('localhost',  'root', '123456');
	mysqli_select_db($connect, 'umat');
...
print "<script language=javascript> alert('게시판 등록이 완료되었습니다.'); location.replace('alogmain.html'); </script>";
